        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          >
            <mesh
              ...
              position={nodes.card.position}
              rotation={nodes.card.rotation}
              scale={nodes.card.scale}
            >
            ...
            <mesh
              ...
              position={nodes.clip.position}
              rotation={nodes.clip.rotation}
              scale={nodes.clip.scale}
              material={materials.metal}
              material-roughness={0.3}
            />
            <mesh
              geometry={nodes.clamp.geometry}
              position={nodes.clamp.position}
              rotation={nodes.clamp.rotation}
              scale={nodes.clamp.scale}
              material={materials.metal}
            />
          </group>
        </RigidBody>
